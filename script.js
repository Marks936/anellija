...
const translations = {
    lv: {
        ...
        'hero.consultation': 'Bezmaksas konsultācija',
        'hero.stat1': 'projektu',
        ...
        'steps.1.d': 'Bezmaksas speciālista izbraukums',
        'steps.2.t': 'Līgums',
        'steps.2.d': 'Fiksējam cenu un termiņus',
        'steps.3.t': 'Montāža',
    ...
    ru: {
        ...
        'hero.subtitle': 'Собственное производство. Гарантия 2 года. Быстрая установка.',
        'hero.cta': 'Позвонить',
        'hero.portfolio': 'Наши работы',
        ...
        'steps.1.t': 'Замер',
        'steps.1.d': 'Бесплатный выезд специалиста',
        'steps.2.t': 'Договор',
        'steps.2.d': 'Фиксируем цену и сроки',
        'steps.3.t': 'Монтаж',
        ...
        'faq.1.a': 'Стандартная установка забора занимает 1-3 дня в зависимости от сложности объекта и погодных условий. (плюс время на производство)',
        'faq.2.q': 'Предоставляете ли вы гарантию на свои работы?',
        'faq.2.a': 'Да, мы предоставляем 2 года гарантии на все установленные заборы и ворота.',
        'faq.3.q': 'Бесплатен ли замер?',
    ...
    en: {
        ...
        'hero.subtitle': 'In-house production. 2-year warranty. Fast installation.',
        'hero.cta': 'Call now',
        'hero.portfolio': 'Our work',
        ...
        'steps.1.d': 'Free site visit and measurement',
        'steps.2.t': 'Contract',
        'steps.2.d': 'Fixed price & terms',
        'steps.3.t': 'Installation',
        ...
        'faq.1.a': 'Standard fence installation takes 1-3 days depending on complexity and weather conditions. (plus time for manufacturing)',
        'faq.2.q': 'Do you provide warranty on your work?',
        'faq.2.a': 'Yes, we provide 2-year warranty on all installed fences and gates.',
        'faq.3.q': 'Is measurement free?',
...
// Current language (default Latvian)
let currentLang = localStorage.getItem('anellija_lang') || 'lv';
...
function setLanguage(lang) {
    currentLang = lang;
    localStorage.setItem('anellija_lang', lang);
...
// ==================== THEME MANAGER ====================
let currentTheme = localStorage.getItem('anellija_theme') || 'dark';
...
function toggleTheme() {
    ...
    localStorage.setItem('anellija_theme', currentTheme);
    applyTheme();
}
